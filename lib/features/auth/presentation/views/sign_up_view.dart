...
import 'package:kakas_task/features/auth/presentation/view_models/auth_providers/sign_up_provider.dart';
            ...
            child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Text('Create new account', style: Styles.textStyle23),
                    SizedBox(
                      height: height * 0.028,
                    ),
                    SizedBox(
                    ...
                    Consumer<SignUpProvider>(
                      builder: (BuildContext context, signUpProvider,
                        ...
                        child: CustomTextFormField(
                          ...
                          suffixIcon: signUpProvider.isObscure
                              ? Icons.visibility
                              : Icons.visibility_off,
                          suffixFun: () =>
                              signUpProvider.changevisibilityPassword(),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                        ...
                        child: MainButton(
                          ...
                          function: () async {
                            if (formKey.currentState!.validate()) {
                              await signUpProvider.userSignUp(
                                  userName: userNameController.text,
                                  password: passwordController.text);
                              if (signUpProvider.signUpModel?.token != null) {
                                GoRouter.of(context).go(RoutesPath.kLoginView);
                                customSnackBar(context, 'Register Successfully',
                                    color: Colors.green);
                              } else {
                                customSnackBar(
                                    context, 'Register Faild. Please try again',
                                    color: Colors.red);
                              }
                            }
                          },
